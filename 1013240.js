! function(e) {
    ...
    window.MarketGidBaseBlockC1013240 = function(e, t, n, o, a, s) {
        ...
        c.sourceName = "", this.templates = [], this.templateId = 0, c.setStyles = function(e) {
            ...
            c.fallbackMode ? c.fallbackMode && 0 == this.countLoadBlocks && (c.root.innerHTML = "", c.context.document.getElementById("M525161PreloadC1013240") && (c.context.document.getElementById("M525161PreloadC1013240").style.display = "none")) : c.context.document.getElementById("MarketGidPreloadC" + this.containerId) ? c.context.document.getElementById("MarketGidPreloadC" + this.containerId).style.display = "none" : c.context.document.getElementById("M525161PreloadC" + this.containerId) ? c.context.document.getElementById("M525161PreloadC" + this.containerId).style.display = "none" : c.context.document.getElementById("MarketGidPreloadN" + this.containerId) ? this.context.document.getElementById("MarketGidPreloadN" + this.containerId).style.display = "none" : c.context.document.getElementById("M525161PreloadN" + this.containerId) && (c.context.document.getElementById("M525161PreloadN" + this.containerId).style.display = "none")
            ...
            if (0 == c.fakeMode && c.processHooks("beforeLoadNewsHooks"), this.isArray(e)) {
                ...
                if (0 == c.fakeMode && void 0 !== c.servicerData.lib) {
                    ...
                    c.context._mgq = c.context._mgq || [], c.context._mgq.push(["_mgload", {
                        ...
                        rootElement: c.root
                    }]), -1 == c.root.className.indexOf("_mgw_1013240") && (c.root.className += (0 == c.root.className.length ? "" : " ") + "_mgw_1013240"), -1 == c.root.className.indexOf("_mgVideoBlock_1013240") && (c.root.className += (0 == c.root.className.length ? "" : " ") + "_mgVideoBlock_1013240");
            ...
            var e = this.context.document,
                ...
                r = "clientWidth",
                o = "scrollTop";
            return c.isAmp() ? void 0 !== t["intersectionRect1013240_" + c.uniqId] ? {
                c: t["intersectionRect1013240_" + c.uniqId].height,
                s: t["intersectionRect1013240_" + c.uniqId].y
            } : {
                c: t.intersectionRect1013240.height,
                s: t.intersectionRect1013240.y
            } : t.innerWidth ? {
                c: t.innerHeight,
                s: t.pageYOffset
            } : e[i] && e[i][r] ? {
            ...
            if ("html" in e) {
                ...
                var o = "mgBanner_1013240_" + this.page + "_" + this.iteration,
            ...
            var n = e ? "fs/" : "",
                o = c.blocksAddress + n;
            if (o += "1013240/" + c.page, t && (c.requestParams.rsh = "rsh=" + t, c.requestParams.initial_composite = "initial_composite=" + c.id), void 0 !== c.context.MGi && (c.requestParams.iso = "iso=" + c.context.MGi, c.requestParams.token = "token=bd00ebe9bc63b8a2c35c56e88b75e107"), c.requestParams.pv = "pv=5", void 0 !== c.context["ampOptions1013240_" + c.uniqId]) {
                try {
                    var a = JSON.parse(c.context["ampOptions1013240_" + c.uniqId])
                } catch (e) {}
            ...
            i.push("url=" + encodeURIComponent(e)), i.push("uuid=" + c.servicerData.rid), i.push("hash=" + r), i.push("cid=1013240"), i.push("gb_uid=57348224"), i.push("h2=" + c.servicerData.h2), i.push("type=" + c.doubleClickType), i.push("checkId=" + c.doubleClickCheckId), t && i.push("isOut=" + t), n.src = c.webProtocol + "//c.mgid.com/doubleclick?" + i.join("&")
    ...
    if (document.getElementById("MG_ID")) {
        var l = document.getElementById("MG_ID").innerHTML,
            d = parent.window.document.getElementById("MarketGidScriptRootC" + l) ? "MarketGidScriptRootC" + l : "M525161ScriptRootC" + l;
        parent.window.document.getElementById(d) && (o = !0)
    } else {
        d = document.getElementById("MarketGidScriptRootC1013240") || document.getElementById("MarketGidScriptRootC1013240") ? "MarketGidScriptRootC1013240" : (document.getElementById("M525161ScriptRootC1013240"), "M525161ScriptRootC1013240");
        document.getElementById(d) && (o = !0, a = !0, s = !0)
    }(document.getElementById("MarketGidComposite1013240") || document.getElementById("M525161Composite1013240")) && (o = !0, a = !0);
    var u = void 0 !== window.uniqId ? window.uniqId : ("00000" + Math.round(1e5 * Math.random()).toString(16)).slice(-5);
    if (!o) {
        if (document.getElementById("MG_ID")) {
            l = document.getElementById("MG_ID").innerHTML, d = parent.window.document.getElementById("MarketGidScriptRootG" + l) ? "MarketGidScriptRootG" + l : "M525161ScriptRootG" + l;
            parent.window.document.getElementById(d) && (o = !0)
        } else {
            d = document.getElementById("MarketGidScriptRootG57348224") ? "MarketGidScriptRootG57348224" : "M525161ScriptRootG57348224";
            document.getElementById(d) && (o = !0, a = !0, s = !0)
        }(document.getElementById("MarketGid0") || document.getElementById("M525161Widget0")) && (o = !0, a = !0), c = !0
    }
    if (o) {
        var h;
        if (c)
            if (a)
                if (s) {
                    (g = document.createElement("div")).id = "MarketGid0", document.getElementById(d).appendChild(g), window.MarketGidInfC1013240 = new MarketGidBaseBlockC1013240(g.id, window, !1, 57348224, u, 11)
                } else {
                    d = document.getElementById("MarketGid0") ? "MarketGid0" : "M525161Widget0", m = document.getElementById("MarketGid0") ? "1" : "2";
                    document.getElementById(d).innerHTML = "", window.MarketGidInfC1013240 = new window.MarketGidBaseBlockC1013240(d, window, !0, 0, u, m)
                }
        else {
            l = document.getElementById("MG_ID").innerHTML;
            (g = parent.window.document.createElement("div")).id = "MarketGid0";
            d = parent.window.document.getElementById("MarketGidScriptRootG" + l) ? "MarketGidScriptRootG" + l : "M525161ScriptRootG" + l, m = parent.window.document.getElementById("MarketGidScriptRootG" + l) ? "6" : "8";
            parent.window.document.getElementById(d).appendChild(g), window.MarketGidInfC1013240 = new window.MarketGidBaseBlockC1013240(g.id, parent.window, !1, l, u, m)
        } else if (a)
            if (s) {
                v = "" != u ? "_" + u : "";
                var f = (document.getElementById("M525161}ScriptRootC1013240") || document.getElementById("M525161ScriptRootC1013240") || document.getElementById("MarketGidScriptRootC1013240"), 1013240);
                if (!window.document.getElementById("MarketGidComposite" + f) || !window.document.getElementById("M525161Composite" + f)) {
                    (g = window.document.createElement("div")).id = "MarketGidComposite" + f + v;
                    var p = window.document.getElementById("MarketGidScriptRootC" + f) ? "MarketGidScriptRootC" + f : "M525161ScriptRootC" + f;
                    window.document.getElementById(p).appendChild(g), window.document.getElementById(p).id = p + v
                }
                y = window.document.getElementById("MarketGidPreloadC" + f) ? "MarketGidPreloadC" + f : "M525161PreloadC" + f;
                window.document.getElementById(y) && (window.document.getElementById(y).id = y + v);
                var d = document.getElementById("MarketGidComposite" + f + v) ? "MarketGidComposite" + f + v : "M525161Composite" + f + v;
                window.MarketGidInfC1013240 = new window.MarketGidBaseBlockC1013240(d, window, !1, f + v, u, 11)
            } else {
                d = document.getElementById("MarketGidComposite1013240") ? "MarketGidComposite1013240" : "M525161Composite1013240";
                var m = document.getElementById("MarketGidComposite1013240") ? "3" : "4";
                document.getElementById(d).innerHTML = "", window.MarketGidInfC1013240 = new window.MarketGidBaseBlockC1013240(d, window, !1, 0, u, m)
            }
        else {
            var g, v = "_" + u,
                l = document.getElementById("MG_ID").innerHTML;
            (g = parent.window.document.createElement("div")).id = "MarketGidComposite1013240" + v;
            var d = parent.window.document.getElementById("MarketGidScriptRootC" + l) ? "MarketGidScriptRootC" + l : "M525161ScriptRootC" + l,
                m = parent.window.document.getElementById("MarketGidScriptRootC" + l) ? "9" : "10";
            parent.window.document.getElementById(d).id = d + v;
            var y = parent.window.document.getElementById("MarketGidPreloadC" + l) ? "MarketGidPreloadC" + l : "M525161PreloadC" + l;
            parent.window.document.getElementById(y) && (parent.window.document.getElementById(y).id = y + v), d += v, parent.window.document.getElementById(d).appendChild(g), window.MarketGidInfC1013240 = new window.MarketGidBaseBlockC1013240(g.id, parent.window, !1, l + v, u, m)
        }
        n(2), window.MarketGidCMainBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Main = "MarketGidCMainBlock1013240", n(3), window.MarketGidCSubnetsBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Subnets = "MarketGidCSubnetsBlock1013240", n(4), window.MarketGidCAdvertLinkBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.AdvertLink = "MarketGidCAdvertLinkBlock1013240", n(5).call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), n(6), window.MarketGidCInternalExchangeBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.InternalExchange = "MarketGidCInternalExchangeBlock1013240", n(7), window.MarketGidCColorBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Color = "MarketGidCColorBlock1013240", n(8), window.MarketGidCUtilsBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Utils = "MarketGidCUtilsBlock1013240", n(9), window.MarketGidCMonitorBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Monitor = "MarketGidCMonitorBlock1013240", n(10), window.MarketGidCChangeColorBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.ChangeColor = "MarketGidCChangeColorBlock1013240", n(12), window.MarketGidCRejectBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Reject = "MarketGidCRejectBlock1013240", n(13), window.MarketGidCCriteoBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Criteo = "MarketGidCCriteoBlock1013240", n(14), window.MarketGidCAmpRenderBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.AmpRender = "MarketGidCAmpRenderBlock1013240", n(15), window.MarketGidCInternalExchangeLoggerBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.InternalExchangeLogger = "MarketGidCInternalExchangeLoggerBlock1013240", n(16), window.MarketGidCMgqBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Mgq = "MarketGidCMgqBlock1013240", n(17), window.MarketGidCStylesheetsBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Stylesheets = "MarketGidCStylesheetsBlock1013240", n(18), window.MarketGidCCookieBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Cookie = "MarketGidCCookieBlock1013240", n(19), window.MarketGidCObserverBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Observer = "MarketGidCObserverBlock1013240", n(20), window.MarketGidCSspDoubleClickBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.SspDoubleClick = "MarketGidCSspDoubleClickBlock1013240", n(21), window.MarketGidCSendDimensionsBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.SendDimensions = "MarketGidCSendDimensionsBlock1013240", n(22), window.MarketGidCAntifraudBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Antifraud = "MarketGidCAntifraudBlock1013240", n(24), window.MarketGidCAntifraudStatisticsBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.AntifraudStatistics = "MarketGidCAntifraudStatisticsBlock1013240", n(26), window.MarketGidCRtbBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Rtb = "MarketGidCRtbBlock1013240", n(27), window.MarketGidCDiscountBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Discount = "MarketGidCDiscountBlock1013240", n(28), window.MarketGidCActivateDelayBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.ActivateDelay = "MarketGidCActivateDelayBlock1013240", n(29), window.MarketGidCIframeSizeChangerBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.IframeSizeChanger = "MarketGidCIframeSizeChangerBlock1013240", "wages".length > 0 && (n(30), window.MarketGidCAccidentalClicksBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.AccidentalClicks = "MarketGidCAccidentalClicksBlock1013240"), n(31), window.MarketGidCExternalCountersBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.ExternalCounters = "MarketGidCExternalCountersBlock1013240", n(32), window.MarketGidCYandexTurboBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.YandexTurbo = "MarketGidCYandexTurboBlock1013240", n(33), window.MarketGidCContentPreviewBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.ContentPreview = "MarketGidCContentPreviewBlock1013240", n(34), window.MarketGidCCountersBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Counters = "MarketGidCCountersBlock1013240";
        ...
        ("in-article" === b.type && "off" !== (null !== (h = b.autoplacement) && void 0 !== h ? h : "off") || ("in-article" === b.type && b.autoplacement, 0)) && (n(35), window.MarketGidCInArticleWidgetBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.InArticleWidget = "MarketGidCInArticleWidgetBlock1013240"); - 1 !== ["header-widget-carousel", "in-article-carousel"].indexOf("in-article-impact") && (n(37), window.MarketGidCCarouselWidgetBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.CarouselWidget = "MarketGidCCarouselWidgetBlock1013240"), window.MarketGidCGradientBlock1013240 = function(e) {
        ...
        }, window.MarketGidCGradientBlock1013240.call(window.MarketGidInfC1013240, window.MarketGidInfC1013240), window.MarketGidInfC1013240.funcBlocks.Gradient = "MarketGidCGradientBlock1013240";
        var k = !0;
        window.mg_loaded_525161_1013240, 0, k && (window.MarketGidInfC1013240.init(), void 0 === window.MarketGidInfC1013240.context.MarketGidC1013240DisableStart && (window.mg_loaded_525161_1013240 = !0, window.MarketGidInfC1013240.start()))
    }
}, function(e, t, i) {
    window.MarketGidCMainBlock1013240 = function(e) {
    ...
    window.MarketGidCSubnetsBlock1013240 = function(e) {
                            ...
                            if (e.originalId = e.id, e.id = t, e.loadedType = "goods", e.currentSubnet = i.id, e.currentSubnetDomain = i.mirror, e.originalId !== e.id && void 0 !== o[e.id] && void 0 !== o[e.id].customFuncBlocks) {
                                ...
                                for (var s in a)
                                    if (a.hasOwnProperty(s)) {
                                        var c = a[s];
                                        window["".concat("MarketGidC").concat(c, "Block").concat(1013240)].call(window["".concat("MarketGidInfC1013240")], window["".concat("MarketGidInfC1013240")]), window["".concat("MarketGidInfC1013240")].funcBlocks["".concat(c)] = "".concat("MarketGidC").concat(c, "Block").concat(1013240)
                                    }
                            }
    ...
    window.MarketGidCAdvertLinkBlock1013240 = function(e) {
        e.beforeLoadNewsHooks.push("refreshAdvertLink"), e.afterLoadNewsHooks.push("initAdvertPopup"), e.getAdvertLinkValue = function() {
            ...
            if (e.context.top === e.context.self && "banner" !== e.widgetConstructorData.type && "exit-pop-up" !== e.widgetConstructorData.type && -1 !== ["tablet", "desktop"].indexOf(e.deviceType) && void 0 === e.context._mgDisableAdvertPopup && n("MarketGidC") + "ConstructorBlock1013240" != "function") {
            ...
            var n = (void 0 !== e.realRoot ? e.realRoot : e.root).parentNode,
                r = n.querySelector("._mgAdvertPopupC1013240"),
    ...
    e.exports = function(e) {
        var t = null;
        e.log = function(i) {
            null === t && "1" == e.getQueryParameterByName("mgwdebug") && (t = !0), t && console.log("WIDGET_".concat(1013240, "_").concat(e.uniqId), i)
        }
    }
}, function(e, t, i) {
    window.MarketGidCInternalExchangeBlock1013240 = function(e) {
    ...
    window.MarketGidCColorBlock1013240 = function(e) {
    ...
    window.MarketGidCUtilsBlock1013240 = function(e) {
    ...
    window.MarketGidCMonitorBlock1013240 = function(e) {
        this.afterLoadNewsHooks.push("monitorInit"), this.shownBlocks = {}, this.monitorTimeout = null, this.isFirstByType = {}, this.isFirstByCid = {}, this.monitorInit = function() {
            ...
            void 0 === a._mgPageImp525161 ? (a._mgPageImp525161 = !0, t += "&pageImp=1") : t += "&pageImp=0";
            try {
                if (e.context.localStorage) {
    ...
    window.MarketGidCChangeColorBlock1013240 = function(e) {
    ...
    window.MarketGidCSmartDoubleClickBlock1013240 = function(e) {
    ...
    window.MarketGidCRejectBlock1013240 = function(e) {
                    ...
                    for (var n = i.getElementsByClassName("mcimg"), r = !1, o = 0; o < n.length; o++)
                        ...
                        if (null != s) {
                            ...
                            if (null != c && "i" != c[1] && 0 == a.length) {
                                ...
                                d.className = "close-informer", d.href = l + "/teaser/" + s[1] + "/widget/" + ("w" == c[1] ? "57348224/type/goods" : "0/type/news"), d.target = "_blank", d.rel = "nofollow", d.style.top = parseInt(u.borderTopWidth) + 3 + "px", d.style.right = parseInt(u.borderRightWidth) + 3 + "px", r.style.position = "relative", r.appendChild(d)
                            }
                        }
                    }
                }
    ...
    window.MarketGidCCriteoBlock1013240 = function(e) {
    ...
    window.MarketGidCAmpRenderBlock1013240 = function(e) {
        e.ampResized = [], e.ampRenderStart = function() {
            ...
            return void 0 !== e.context.context && void 0 !== e.context.context.data && void 0 !== e.context.context.data.widget || void 0 !== e.context.boundingClientRect1013240 && void 0 !== e.context.intersectionRect1013240
    ...
    window.MarketGidCInternalExchangeLoggerBlock1013240 = function(e) {
    ...
    window.MarketGidCMgqBlock1013240 = function(e) {
    ...
    window.MarketGidCStylesheetsBlock1013240 = function(e) {
        e.stylesDom = {}, e.isIE = "undefined" == typeof Proxy, e.addStyle = function(t, i, n) {
            ...
            if (n) {
                var r = n;
                if (r.className = "MarketGidC1013240", r.styleSheet) r.styleSheet.cssText = t;
                else {
                ...
                o.setAttribute("id", i), o.className = "MarketGidC1013240", o.type = "text/css", (void 0 !== e.realRoot ? e.realRoot : e.root).appendChild(o), o.styleSheet ? o.styleSheet.cssText = t : o.appendChild(e.context.document.createTextNode(t))
            }
    ...
    window.MarketGidCCookieBlock1013240 = function(e) {
        this.storageName = "MarketGidStorage" + (this.context.MarketGidPageOffset ? this.context.MarketGidPageOffset : ""), this.getCookieValue = function() {
            ...
            void 0 !== e.C1013240 ? this.cookieStorage = e.C1013240 : this.cookieStorage = {}, void 0 !== e[0] ? this.sharedCookieStorage = e[0] : this.sharedCookieStorage = {}
        }, this.setCookie = function() {
            var e = this.getCookieValue();
            e.C1013240 = this.cookieStorage, e[0] = this.sharedCookieStorage;
    ...
    window.MarketGidCObserverBlock1013240 = function(e) {
    ...
    window.MarketGidCSspDoubleClickBlock1013240 = function(e) {
        ...
        e.doubleclickStyles = ".MarketGidDButton1013240{display:       inline-block;", e.doubleclickStyles += 'width:         80px;height:        80px;background-color: RGBA(0,0,0,0.4);border:        2px solid white;border-radius:        999px;color:         white !important;font:          normal 500 24px/80px "Sans", sans-serif;transform: scale3d(0.0001,0.0001,0.0001);', e.doubleclickStyles += "text-align:    center;text-shadow:   none;position: absolute;text-decoration: none !important;transition:all 1s;}.MarketGidDLayout1013240{height: 100%;width: 100% !important;position: absolute !important;top: 0px;left: 0px;background-color: rgba(0, 0, 0, 0.5);z-index: 99999;}#MarketGidComposite1013240 .mgline {position:relative}", e.addStyle("ssp_doubleclick", e.doubleclickStyles), e.hashTimer = [], e.servicerDoubleClickStatus = !1, e.sspDoubleClickHook = function() {
            ...
            var n = t.getAttribute("data-hash"),
                r = (new Date).getTime();
            return n in e.hashTimer && r - e.hashTimer[n] > e.servicerData.dc || "w" !== e.teaserData[n].coopType || "MarketGidDButton1013240" === t.className ? (e.doubleClickHandler(t, !0), !0) : (e.doubleClickHandler(t), i.preventDefault(), e.renderDoubleClick(t), !1)
    ...
    window.MarketGidCSendDimensionsBlock1013240 = function(e) {
        e.afterPreRenderNewsHooks.push("calcPreRenderingBlock"), e.blankImage = "data:image/gif;base64,", e.precalcRect = {}, e.calcPreRenderingBlock = function() {
            setTimeout((function() {
                ...
                0 == n && (n = r.length), e.requestParams.cols = "cols=" + n, e.fakeMode = !1, e.root = e.realRoot, null !== e.root.querySelector("#preRenderingBlock1013240_" + e.uniqId) && e.root.removeChild(e.root.querySelector("#preRenderingBlock1013240_" + e.uniqId)), e.root.style.overflow = "visible", e.root.style.visibility = "visible", e.root.style.width = e.precalcRect.width + "px", e.root.style.height = e.precalcRect.height + "px", e.afterLoadNewsHooks.push("clearReservationStyles"), e.clearReservationStyles = function() {
            ...
            var i = e.context.document.createElement("div");
            i.id = "preRenderingBlock1013240_" + e.uniqId, i.style.visibility = "hidden";
    ...
    window.MarketGidCAntifraudStatisticsBlock1013240 = function(e) {
        var t = i(25),
            r = function() {
                function t() {
                    n(this, t)
    ...
    window.MarketGidCRtbBlock1013240 = function(e) {
        this.afterLoadNewsHooks.push("cmPixelLoad"), this.cmPixelLoad = function(t) {
            if (!e.context["i.js.loaded"] && e.cookieMatchingDomain) {
                ...
                var i = window.MarketGidInfC1013240.context.document.createElement("script");
                i.charset = "utf-8";
                ...
                }, (void 0 !== window.MarketGidInfC1013240.realRoot ? window.MarketGidInfC1013240.realRoot : window.MarketGidInfC1013240.root).parentNode.appendChild(i)
            }
    ...
    window.MarketGidCDiscountBlock1013240 = function(e) {
        this.afterLoadNewsHooks.push("discountsLoader"), this.discountMouseOver = function(t) {
            e.helpIE(this);
            var i = this.getElementsByClassName("mcpriceold57348224"),
                n = this.getElementsByClassName("mcprice57348224"),
                r = this.getElementsByClassName("mcdiscount57348224");
            ...
            e.helpIE(this);
            var i = this.getElementsByClassName("mcdiscount57348224"),
                n = this.getElementsByClassName("mcprice57348224"),
                r = this.getElementsByClassName("mcpriceold57348224");
            ...
            if (this.root) {
                ...
                var e, t = i(this.root.getElementsByClassName("mcteaser57348224"));
                try {
                    for (t.s(); !(e = t.n()).done;) {
                        var n = e.value;
    ...
    window.MarketGidCActivateDelayBlock1013240 = function(e) {
        var t;
        e.clickableDelay = !1;
        var i = !1;
    ...
    window.MarketGidCIframeSizeChangerBlock1013240 = function(e) {
    ...
    window.MarketGidCAccidentalClicksBlock1013240 = function(e) {
    ...
    window.MarketGidCExternalCountersBlock1013240 = function(e) {
    ...
    window.MarketGidCYandexTurboBlock1013240 = function(e) {
        e.isTurbo = function() {
    ...
    window.MarketGidCContentPreviewBlock1013240 = function(e) {
    ...
    window.MarketGidCCountersBlock1013240 = function(e) {
        this.afterLoadNewsHooks.push("countersLoad"), this.countersLoad = function() {
            if (parseInt(e.id) !== parseInt(1013240)) {
    ...
    var r = i(36);
    window.MarketGidCInArticleWidgetBlock1013240 = function(e) {
    ...
    window.MarketGidCCarouselWidgetBlock1013240 = function(e) {
